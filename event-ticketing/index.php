...
<section class="hero">
    ...
    <p>
        Grab your tickets for upcoming campus events before they sell out.
    </p>
</section>
...
<section>
    ...
    <div class="card">
        ...
        <img
            class="card-thumb"
            src="<?= htmlspecialchars(entity_image_url($e)) ?>"
            alt="<?= htmlspecialchars($e['event_name']) ?>"
            loading="lazy">
        ...
        <?php else: ?>
            ...
            <?php if (current_user_id()): ?>
                ...
                <?php if ($e['has_seating']): ?>
                    ...
                    <a
                        class="btn"
                        href="seat_select.php?event_id=<?= (int)$e['id'] ?>">
                        Select Seats
                    </a>
                ...
                <?php else: ?>
                    ...
                    <a
                        class="btn"
                        href="create.php?event_id=<?= (int)$e['id'] ?>">
                        Buy Tickets
                    </a>
    ...
    href="add_to_calendar.php?event_id=<?= (int)$e['id'] ?>">
    Add to Calendar
</a>
        <?php endif; ?>
...
<section>
    ...
    <?php if (!current_user_id()): ?>
        ...
        <p>
            ...
            to view and manage your ticket orders.
        </p>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a
                            ...
                            href="confirmation.php?id=<?= (int)$o['id'] ?>">
                            View Tickets
                        </a>
